<nav x-data="{ open: false }" class="bg-white border-b border-gray-100" style="border-top: solid 5px orange;">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-12 w-12 fill-current text-black-800" />
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.edit')" class="hover:text-orange-600">
                            {{ __('Profile') }}
                        </x-dropdown-link>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')" class="hover:text-orange-600"
